...
from src.utils.text_utils import is_toc_page_by_density
...
def convert_doc_to_markdown(document, structured_toc, output_path=None):
    """Convert extracted document pages into markdown text and optionally save to a .md file.

    Args:
        document: A list of page dictionaries with a 'text' field.
        structured_toc: A list of tuples (title, prefix) produced by toc_to_markdown.
        output_path: Optional file path to write the generated markdown to.

    Returns:
        The generated markdown document as a single string.
    """
    result = []
